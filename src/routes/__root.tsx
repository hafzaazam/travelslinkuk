...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "UK-based visa consultancy helping students, professionals, families and tourists obtain visas to 25+ countries with confidence." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Travel Links Solution — UK Visa Consultancy" },
      { name: "twitter:description", content: "UK-based visa consultancy helping students, professionals, families and tourists obtain visas to 25+ countries with confidence." },
