...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Travellinks Solution - Visa Consultancy" },
      { property: "og:title", content: "Travellinks Solution - Visa Consultancy" },
      { name: "twitter:title", content: "Travellinks Solution - Visa Consultancy" },
      { name: "description", content: "A simple application that greets users with a friendly \"Hello!\"." },
      { property: "og:description", content: "A simple application that greets users with a friendly \"Hello!\"." },
      { name: "twitter:description", content: "A simple application that greets users with a friendly \"Hello!\"." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6feb6fc2-d976-4dbe-ba22-b03f89ee29f1/id-preview-2f7638bf--1f5f9a7e-f63a-490d-8ae6-c9c048fe3a19.lovable.app-1783077052400.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6feb6fc2-d976-4dbe-ba22-b03f89ee29f1/id-preview-2f7638bf--1f5f9a7e-f63a-490d-8ae6-c9c048fe3a19.lovable.app-1783077052400.png" },
    ],
    links: [
